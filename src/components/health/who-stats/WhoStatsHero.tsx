...
import { WhoStatsWhoBadge } from '@/components/health/who-stats/WhoStatsWhoBadge'
...
export function WhoStatsHero({ onRefresh, refreshing, loading, whoProfileUrl }: Props) {
    ...
    <section className="relative overflow-hidden border-b border-primary/10">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-12 md:py-16">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex w-full shrink-0 flex-col gap-3 rounded-2xl border border-primary/15 bg-card/90 p-4 shadow-lg backdrop-blur-sm lg:w-[min(100%,300px)]">
            <div>
            ...
            <WhoStatsWhoBadge whoProfileUrl={whoProfileUrl ?? WHO_PAKISTAN_PROFILE_URL} />
          </div>
        </div>
      </div>
    </section>
